...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('intouch.beheer.roles.update', $role) }}">
            @csrf
            @method('put')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug', $role->slug) }}" pattern="[a-z0-9_]+" required>
            ...
            <a href="{{ route('intouch.beheer.roles.index') }}" class="btn btn-outline-secondary">Terug</a>
        </form>
    </div>
</div>
